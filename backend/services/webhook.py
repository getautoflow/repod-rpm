"""
services/webhook.py — [K] Webhooks entrants (GitHub Security Advisory + CISA KEV)
...
Fonctions :
  ...
  update_kev_flag()          — Propage in_kev=True sur les manifests RPM affectés
...
# ── Propagation du flag KEV sur les manifests RPM ─────────────────────────────

def update_kev_flag(cve_id: str) -> int:
    """
    Marque in_kev=True pour tous les paquets RPM ayant cve_id dans leurs résultats CVE.
