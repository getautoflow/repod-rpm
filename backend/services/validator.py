...
from services.manifest import parse_rpm_fields, parse_rpm_requires, parse_dependencies, compute_sha256
...
def validate_gpg(rpm_path: str, result: ValidationResult):
    """
