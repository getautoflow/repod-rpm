...
Rôle   : [T] Métriques Prometheus + request-id middleware
...
class TestMetricsModuleExists:
    ...
    def test_metrics_module_file_exists(self):
        ...
        assert p.exists(), "services/metrics.py doit être créé ([T] Prometheus)"
...
# ═══════════════════════════════════════════════════════════════════════════════
# 3. Middleware — middleware/metrics_middleware.py
# ═══════════════════════════════════════════════════════════════════════════════
...
class TestMetricsMiddlewareExists:
    ...
    def test_middleware_file_exists(self):
        ...
        assert p.exists(), "middleware/metrics_middleware.py doit être créé ([T])"
...
class TestMetricsRouterExists:
    ...
    def test_metrics_router_file_exists(self):
        ...
        assert p.exists(), "routers/metrics_router.py doit être créé ([T])"
